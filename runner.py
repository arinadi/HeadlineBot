...
def main():
    ...
    if os.path.exists(".git"):
        ...
        print("⏳ Updating current directory...")
    ...
    # 2. Install Core Dependencies (Lightning Fast)
    print("⏳ Installing core dependencies (Waiter is coming)...")
